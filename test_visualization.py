...
def cones_detection_save(target_path,output_path,model,device,conf_thres,nms_thres):
...
def main(target_path,output_path,weights_path,model_cfg,conf_thres,nms_thres,xy_loss,wh_loss,no_object_loss,object_loss,vanilla_anchor):
    ...
    for fname in images:
        cones_detection_save(target_path=fname,output_path=output_path,model=model,device=device,conf_thres=conf_thres,nms_thres=nms_thres)
